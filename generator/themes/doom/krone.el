...
;;
(defgroup krone-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom krone-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'krone-theme
  :type 'boolean)

(defcustom krone-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'krone-theme
  :type 'boolean)

(defcustom krone-comment-bg krone-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'krone-theme
  :type 'boolean)

(defcustom krone-padded-modeline nil
...
(def-doom-theme krone
  ...
  ((bg         '("#1c1c1c" nil       nil            ))
   ...
   (orange     '("#FAEF6B" "#6e43e5" "brightred"    )) ; Numbers
   (green      '("#946BFB" "#6e43e5" "green"        )) ; Strings, brackets
   (teal       '("#946BFB" "#6e43e5" "brightgreen"  )) ; Only hydra and rainbow delimiters
   (yellow     '("#946BFB" "#6e43e5" "yellow"       )) ; Objects, types, Lisp functions
   ...
   ;; custom categories
   (-modeline-bright krone-brighter-modeline)
   (-modeline-pad
    (when krone-padded-modeline
      (if (integerp krone-padded-modeline) krone-padded-modeline 4)))
