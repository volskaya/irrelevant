...
;;
(defgroup yulon-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom yulon-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'yulon-theme
  :type 'boolean)

(defcustom yulon-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'yulon-theme
  :type 'boolean)

(defcustom yulon-comment-bg yulon-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'yulon-theme
  :type 'boolean)

(defcustom yulon-padded-modeline nil
...
(def-doom-theme yulon
  ...
  ((bg         '("#1c1c1c" nil       nil            ))
   ...
   (orange     '("#946BFB" "#6e43e5" "brightred"    )) ; Numbers
   (green      '("#00FF98" "#6e43e5" "green"        )) ; Strings, brackets
   (teal       '("#00FF98" "#6e43e5" "brightgreen"  )) ; Only hydra and rainbow delimiters
   (yellow     '("#00FF98" "#6e43e5" "yellow"       )) ; Objects, types, Lisp functions
   ...
   ;; custom categories
   (-modeline-bright yulon-brighter-modeline)
   (-modeline-pad
    (when yulon-padded-modeline
      (if (integerp yulon-padded-modeline) yulon-padded-modeline 4)))
