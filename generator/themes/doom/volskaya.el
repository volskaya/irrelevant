...
;;
(defgroup volskaya-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom volskaya-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'volskaya-theme
  :type 'boolean)

(defcustom volskaya-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'volskaya-theme
  :type 'boolean)

(defcustom volskaya-comment-bg volskaya-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'volskaya-theme
  :type 'boolean)

(defcustom volskaya-padded-modeline nil
...
(def-doom-theme volskaya
  ...
  ((bg         '("#1c1c1c" nil       nil            ))
   ...
   (orange     '("#FF1652" "#6e43e5" "brightred"    )) ; Numbers
   (green      '("#B2FA52" "#6e43e5" "green"        )) ; Strings, brackets
   (teal       '("#B2FA52" "#6e43e5" "brightgreen"  )) ; Only hydra and rainbow delimiters
   (yellow     '("#B2FA52" "#6e43e5" "yellow"       )) ; Objects, types, Lisp functions
   ...
   ;; custom categories
   (-modeline-bright volskaya-brighter-modeline)
   (-modeline-pad
    (when volskaya-padded-modeline
      (if (integerp volskaya-padded-modeline) volskaya-padded-modeline 4)))
