...
;;
(defgroup sakura-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom sakura-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'sakura-theme
  :type 'boolean)

(defcustom sakura-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'sakura-theme
  :type 'boolean)

(defcustom sakura-comment-bg sakura-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'sakura-theme
  :type 'boolean)

(defcustom sakura-padded-modeline nil
...
(def-doom-theme sakura
  ...
  ((bg         '("#1c1c1c" nil       nil            ))
   ...
   (orange     '("#B3FA75" "#6e43e5" "brightred"    )) ; Numbers
   (green      '("#FB76C1" "#6e43e5" "green"        )) ; Strings, brackets
   (teal       '("#FB76C1" "#6e43e5" "brightgreen"  )) ; Only hydra and rainbow delimiters
   (yellow     '("#FB76C1" "#6e43e5" "yellow"       )) ; Objects, types, Lisp functions
   ...
   ;; custom categories
   (-modeline-bright sakura-brighter-modeline)
   (-modeline-pad
    (when sakura-padded-modeline
      (if (integerp sakura-padded-modeline) sakura-padded-modeline 4)))
