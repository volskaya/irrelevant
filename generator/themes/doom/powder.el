...
;;
(defgroup powder-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom powder-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'powder-theme
  :type 'boolean)

(defcustom powder-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'powder-theme
  :type 'boolean)

(defcustom powder-comment-bg powder-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'powder-theme
  :type 'boolean)

(defcustom powder-padded-modeline nil
...
(def-doom-theme powder
  ...
  ((bg         '("#1c1c1c" nil       nil            ))
   ...
   (orange     '("#BFF5FF" "#6e43e5" "brightred"    )) ; Numbers
   (green      '("#EDB1FF" "#6e43e5" "green"        )) ; Strings, brackets
   (teal       '("#EDB1FF" "#6e43e5" "brightgreen"  )) ; Only hydra and rainbow delimiters
   (yellow     '("#EDB1FF" "#6e43e5" "yellow"       )) ; Objects, types, Lisp functions
   ...
   ;; custom categories
   (-modeline-bright powder-brighter-modeline)
   (-modeline-pad
    (when powder-padded-modeline
      (if (integerp powder-padded-modeline) powder-padded-modeline 4)))
