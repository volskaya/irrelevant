...
;;
(defgroup vaatu-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom vaatu-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'vaatu-theme
  :type 'boolean)

(defcustom vaatu-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'vaatu-theme
  :type 'boolean)

(defcustom vaatu-comment-bg vaatu-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'vaatu-theme
  :type 'boolean)

(defcustom vaatu-padded-modeline nil
...
(def-doom-theme vaatu
  ...
  ((bg         '("#1c1c1c" nil       nil            ))
   ...
   (orange     '("#FFFF33" "#6e43e5" "brightred"    )) ; Numbers
   (green      '("#f148fb" "#6e43e5" "green"        )) ; Strings, brackets
   (teal       '("#f148fb" "#6e43e5" "brightgreen"  )) ; Only hydra and rainbow delimiters
   (yellow     '("#f148fb" "#6e43e5" "yellow"       )) ; Objects, types, Lisp functions
   ...
   ;; custom categories
   (-modeline-bright vaatu-brighter-modeline)
   (-modeline-pad
    (when vaatu-padded-modeline
      (if (integerp vaatu-padded-modeline) vaatu-padded-modeline 4)))
