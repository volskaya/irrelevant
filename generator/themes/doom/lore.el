...
;;
(defgroup lore-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom lore-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'lore-theme
  :type 'boolean)

(defcustom lore-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'lore-theme
  :type 'boolean)

(defcustom lore-comment-bg lore-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'lore-theme
  :type 'boolean)

(defcustom lore-padded-modeline nil
...
(def-doom-theme lore
  ...
  ((bg         '("#1c1c1c" nil       nil            ))
   ...
   (orange     '("#a39a89" "#6e43e5" "brightred"    )) ; Numbers
   (green      '("#e2cc9e" "#6e43e5" "green"        )) ; Strings, brackets
   (teal       '("#e2cc9e" "#6e43e5" "brightgreen"  )) ; Only hydra and rainbow delimiters
   (yellow     '("#e2cc9e" "#6e43e5" "yellow"       )) ; Objects, types, Lisp functions
   ...
   ;; custom categories
   (-modeline-bright lore-brighter-modeline)
   (-modeline-pad
    (when lore-padded-modeline
      (if (integerp lore-padded-modeline) lore-padded-modeline 4)))
