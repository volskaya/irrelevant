...
;;
(defgroup jinx-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom jinx-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'jinx-theme
  :type 'boolean)

(defcustom jinx-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'jinx-theme
  :type 'boolean)

(defcustom jinx-comment-bg jinx-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'jinx-theme
  :type 'boolean)

(defcustom jinx-padded-modeline nil
...
(def-doom-theme jinx
  ...
  ((bg         '("#1c1c1c" nil       nil            ))
   ...
   (orange     '("#5CC0E6" "#6e43e5" "brightred"    )) ; Numbers
   (green      '("#F4009E" "#6e43e5" "green"        )) ; Strings, brackets
   (teal       '("#F4009E" "#6e43e5" "brightgreen"  )) ; Only hydra and rainbow delimiters
   (yellow     '("#F4009E" "#6e43e5" "yellow"       )) ; Objects, types, Lisp functions
   ...
   ;; custom categories
   (-modeline-bright jinx-brighter-modeline)
   (-modeline-pad
    (when jinx-padded-modeline
      (if (integerp jinx-padded-modeline) jinx-padded-modeline 4)))
