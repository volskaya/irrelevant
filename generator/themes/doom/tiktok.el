...
;;
(defgroup tiktok-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom tiktok-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'tiktok-theme
  :type 'boolean)

(defcustom tiktok-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'tiktok-theme
  :type 'boolean)

(defcustom tiktok-comment-bg tiktok-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'tiktok-theme
  :type 'boolean)

(defcustom tiktok-padded-modeline nil
...
(def-doom-theme tiktok
  ...
  ((bg         '("#1c1c1c" nil       nil            ))
   ...
   (orange     '("#FE2C55" "#6e43e5" "brightred"    )) ; Numbers
   (green      '("#25F4EE" "#6e43e5" "green"        )) ; Strings, brackets
   (teal       '("#25F4EE" "#6e43e5" "brightgreen"  )) ; Only hydra and rainbow delimiters
   (yellow     '("#25F4EE" "#6e43e5" "yellow"       )) ; Objects, types, Lisp functions
   ...
   ;; custom categories
   (-modeline-bright tiktok-brighter-modeline)
   (-modeline-pad
    (when tiktok-padded-modeline
      (if (integerp tiktok-padded-modeline) tiktok-padded-modeline 4)))
