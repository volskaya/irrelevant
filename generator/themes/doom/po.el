...
;;
(defgroup po-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom po-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'po-theme
  :type 'boolean)

(defcustom po-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'po-theme
  :type 'boolean)

(defcustom po-comment-bg po-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'po-theme
  :type 'boolean)

(defcustom po-padded-modeline nil
...
(def-doom-theme po
  ...
  ((bg         '("#1c1c1c" nil       nil            ))
   ...
   (orange     '("#f9545e" "#6e43e5" "brightred"    )) ; Numbers
   (green      '("#FFFF0A" "#6e43e5" "green"        )) ; Strings, brackets
   (teal       '("#FFFF0A" "#6e43e5" "brightgreen"  )) ; Only hydra and rainbow delimiters
   (yellow     '("#FFFF0A" "#6e43e5" "yellow"       )) ; Objects, types, Lisp functions
   ...
   ;; custom categories
   (-modeline-bright po-brighter-modeline)
   (-modeline-pad
    (when po-padded-modeline
      (if (integerp po-padded-modeline) po-padded-modeline 4)))
