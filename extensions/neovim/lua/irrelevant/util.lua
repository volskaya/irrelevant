local ts = require("irrelevant.treesitter")
...
function M.invert_color(color)
  local hsluv = require("irrelevant.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  local group = vim.api.nvim_create_augroup("irrelevant", { clear = true })
...
function M.terminal(colors)
  vim.g.terminal_color_0 = colors.background -- Black.
  vim.g.terminal_color_8 = colors.gray1 -- Black Bright.

  vim.g.terminal_color_7 = colors.gray0 -- White.
  vim.g.terminal_color_15 = colors.foreground -- White Bright.

  vim.g.terminal_color_1 = colors.danger -- Red.
  vim.g.terminal_color_9 = colors.number -- Red Bright.

  vim.g.terminal_color_2 = colors.accent -- Green.
  vim.g.terminal_color_10 = colors.accent -- Green Bright.

  vim.g.terminal_color_3 = colors.number -- Yellow.
  vim.g.terminal_color_11 = colors.gray6 -- Yellow Bright.

  vim.g.terminal_color_4 = colors.gray3 -- Blue.
  vim.g.terminal_color_12 = colors.gray3 -- Blue Bright.

  vim.g.terminal_color_5 = colors.gray4 -- Magenta.
  vim.g.terminal_color_13 = colors.gray4 -- Magenta Bright.

  vim.g.terminal_color_6 = colors.gray5 -- Cyan.
  vim.g.terminal_color_14 = colors.gray5 -- Cyan Bright.
end
...
function M.load(theme)
  ...
  vim.g.colors_name = "irrelevant-" .. theme.config.style
